...
if __name__ == "__main__":
    ...
    overlay_folder_path = video_name + "_endpoints"
    output_folder_path = video_name + "_overlayed_images"
    overlay_folders(input_folder_path, overlay_folder_path, output_folder_path)
