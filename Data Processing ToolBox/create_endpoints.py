...
def analyze_skeleton(binary_mask):
    # Try this, if fails, just continue and return empty path
    try:
        ...
        return endpoint_coords, quartile_coords, path
    except:
        return [], [], []
...
def process_image(image_path):
    ...
    for region in regionprops(labeled_mask):
        ...
        endpoint_coords, quartile_coords, path = analyze_skeleton(worm_mask)
        if len(path) == 0:
            continue
    ...
    with open('data.csv', 'w', newline='') as file:
        ...
        for file_name in sorted_file_names:
            ...
            if file_name.endswith(".png"):
                ...
                worm_data, analyzed_img = process_image(input_image_path)
...
if __name__ == "__main__":
    ...
    input_folder_path = video_name + "_skeletonized_masks"
    output_folder_path = video_name + "_endpoints"
    create_endpoints_folder(input_folder_path, output_folder_path)
