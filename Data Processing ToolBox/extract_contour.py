...
if __name__ == "__main__":
    input_folder_path = "WormParticles45um-3.0-Wrm2_frames"
    output_folder_path = "WormParticles45um-3.0-Wrm2_contours"
    contours = get_contours_folder(input_folder_path, output_folder_path)
